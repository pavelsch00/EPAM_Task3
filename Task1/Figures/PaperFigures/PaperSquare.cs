...
namespace Task3.Figure.PaperFigure
{
    ...
    public class PaperSquare : Square, IPaper
    {
        ...
        public PaperSquare(IFigure polygonFigure, List<double> sides, Color color) : base(sides)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            PaperSquare square = (PaperSquare)obj;

            return (base.Equals(obj) && (Color == square.Color));
        }
